        ...
        <div class="container mx-auto">
            ...
            <div class="row">
                <div class="col-sm-6">
                    ...
                    <p class="text-gray-600 px-6">Živnostenský list vydaný dňa 19.01.1998 pod. sp.č.: Žo 98/00061/000 reg. č. 36/98</p>
                ...
                <div class="mt-5 p-6 font-bold text-gray-500 max-w-3xl">
                    ...
                    <form method="POST">
                        ...
                        <div class="input-group mb-3">
                            ...
                            <input type="text" name="name" class="border-2 w-full rounded shadow-md p-2 border-gray-500"  placeholder="Meno" value="{{ old('name') }}" aria-describedby="name"/>
                        </div>
                        ...
                        <div class="input-group mb-3">
                            ...
                            <input type="email" name="email" class="border-2 w-full rounded shadow-md p-2 border-gray-500"  placeholder="Emailový kontakt" value="{{ old('email') }}" required aria-describedby="email"/>
                        </div>


                        <div class="input-group mb-3">
                            <textarea class="border-2 w-full rounded shadow-md p-2 border-gray-500" name="text" placeholder="Vaša správa ..." rows="7" required></textarea>
                        </div>
