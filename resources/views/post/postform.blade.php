...
<div class="md:flex mb-4">
    <div class="md:w-1/3 p-2">
        ...
        <select id="category" name="category_id" class="input-control block appearance-none w-full bg-white border border-gray-400 hover:border-gray-500 px-4 py-2 pr-8 rounded shadow leading-tight focus:outline-none focus:shadow-outline">
    ...
    <div class="md:w-1/3 p-2 {{ $errors->has('company_id') ? ' has-error' : '' }}">
        ...
        <select name="contact_id" class="input-control block appearance-none w-full bg-white border border-gray-400 hover:border-gray-500 px-4 py-2 pr-8 rounded shadow leading-tight focus:outline-none focus:shadow-outline" required id="exampleSelect1">
...
<div class="mb-8">
    ...
    <div class="flex justify-between">
        ...
        <button type="submit" class="btn btn-primary mx-2 w-1/6 shadow-md">Uložiť</button>
    </div>
