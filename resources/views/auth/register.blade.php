...
@section('content')
    <section class="absolute w-full h-full">
        <div class="absolute top-0 w-full h-full bg-gray-900"
             style="background-image: url(&quot;https://demos.creative-tim.com/tailwindcss-starter-project/static/media/register_bg_2.2fee0b50.png&quot;); background-size: 100%; background-repeat: no-repeat;"></div>
                ...
                <div class="w-full lg:w-4/12 sm:px-0 pt-32">
                    <div
                        ...
                        <form class=" px-6 py-6" method="POST" action="{{ route('register') }}">
                            ...
                            <div class="relative w-full mb-3">
                                <label for="password"
                                       class="block uppercase text-gray-700 text-xs font-bold mb-2">Heslo</label>
                            ...
                            <div class="relative w-full mb-3">
                                <label for="password-confirm"
                                       class="block uppercase text-gray-700 text-xs font-bold mb-2">Zopakovať
                                    heslo</label>
