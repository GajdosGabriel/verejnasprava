            ...
            <div class="relative flex flex-col min-w-0 break-words w-full mb-6 shadow-lg rounded-lg bg-gray-300 border-0">
                <div class="rounded-t mb-0 px-6 py-6">
                    <div class="text-center mb-3">
                        <h6 class="text-gray-600 text-sm font-bold">Registrácia cez</h6>
                    </div>
                    <div class="btn-wrapper text-center">
                        <a href="/auth/facebook"
                            class="w-full bg-blue-800 hover:bg-blue-900 text-white font-bold py-2 px-4 focus:outline-none focus:shadow-outline">Registrácia
                            cez Facebook</a>
                ...
                <form class=" px-6 py-6" method="POST" action="{{ route('register') }}">
                    ...
                    <div class="relative w-full mb-3">
                        ...
                        <input id="first_name" type="text"
                            class="px-3 py-3 placeholder-gray-400 text-gray-700 bg-white rounded text-sm shadow focus:outline-none focus:shadow-outline w-full @error('first_name') is-invalid @enderror"
                    ...
                    <div class="relative w-full mb-3">
                        <label for="last_name"
                            class="block uppercase text-gray-700 text-xs font-bold mb-2">Priezvisko</label>
                        <input id="last_name" type="text"
                            class="px-3 py-3 placeholder-gray-400 text-gray-700 bg-white rounded text-sm shadow focus:outline-none focus:shadow-outline w-full @error('last_name') is-invalid @enderror"
                    ...
                    <div class="relative w-full mb-3">
                        <label for="email" class="block uppercase text-gray-700 text-xs font-bold mb-2">E-Mailová
                            Adresa</label>
                        <input id="email" type="email"
                            class="px-3 py-3 placeholder-gray-400 text-gray-700 bg-white rounded text-sm shadow focus:outline-none focus:shadow-outline w-full @error('email') is-invalid @enderror"
                    ...
                    <div class="relative w-full mb-3">
                        <label for="password-confirm" class="block uppercase text-gray-700 text-xs font-bold mb-2">Zopakovať
                            heslo</label>
                    ...
                    <div class="my-5">
                        <div class="flex content-center">
                            ...
                            <input id="iamHuman" type="number"
                                class="ml-3 px-3 text-gray-900 bg-white rounded text-sm shadow focus:outline-none focus:shadow-outline w-full"
                                placeholder="napíšte číslo 5" name="iamHuman" required>
                        </div>
                        @error('iamHuman')
