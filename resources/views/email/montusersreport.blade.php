                                                    ...
                                                    <table border="0" cellpadding="30" cellspacing="0" width="100%">
                                                        <tr>
                                                            <td align="center" valign="top" class="textContent">
                                                                <h2 style="color:#FFFFFF;line-height:100%;font-family:Helvetica,Arial,sans-serif;font-size:35px;font-weight:normal;margin-bottom:5px;text-align:center;"><span style="color: wheat">Mesačný výpis dokladov</span> <br> {{ date("M Y", strtotime( date( "M Y", strtotime( date("M Y") ) ) . "-1 month" ) ) }}</h2>
                                                                <h3 style="text-align:center;font-weight:normal;font-family:Helvetica,Arial,sans-serif;font-size:23px;margin-bottom:10px;color:#205478;line-height:135%;">Zverejnených na verejnyportal.eu</h3>
                                                            </td>
                                                        </tr>
                                                    </table>
                                                    <!-- // CONTENT TABLE -->
...
{{--                                                                            <a href="http://verejnyportal.eu/{{ $user->slug }}"><img style="height: 100px; float: right; margin-top: -30px" src="http://verejnyportal.eu/image/dievca.png"></a>--}}

                                                                            <div style="text-align:center;font-family:Helvetica,Arial,sans-serif;font-size:18px; font-weight: 900; float: left; margin-bottom:0;color:#FFFFFF;line-height:135%;">

                                                                                <a href="http://verejnyportal.eu/{{ $user->slug }}">{{ $user->company }}</a> ,  {{ $user->street }}, {{$user->city}}
                                                                            </div>
                                                                        </td>
                                ...
                                <tr>
                                    <td align="center" valign="top">
                                        ...
                                        <table border="0" cellpadding="30" cellspacing="0" width="550" class="flexibleContainer">
                                            <tr>
                                                <td style="padding-top:0;" align="center" valign="top" width="550" class="flexibleContainerCell">

                                                    <!-- CONTENT TABLE // -->
                                                    <table style="margin: -25px;" align="left" border="0" cellpadding="0" cellspacing="0" class="flexibleContainer">
                                                        <tr style="padding: 5px ;background: rgba(91, 113, 250, 0.33)">
                                                        <th>Pč.</th>
                                                        <th style="width: 51%">Popis položky</th>
                                                        <th style="width:29%;">Vytvorené</th>
                                                        {{--<th> </th>--}}
                                                        <th style="width: 25%">Euro</th>

                                                        </tr>
                                                        <?php $i=1; ?>
                                                        @forelse($posts as $post)
                                                        <tr style="border: solid 1px #3f7e80">
                                                        <td>{{$i++}}.</td>
                                                        <td>{{ Str::limit($post->name, 45) }}</td>
                                                        <td style="text-align: center;">{{ $post->date_in }}</td>
                                                        {{--<td></td>--}}
                                                        <td style="text-align: right"><strong>{{ number_format($post->price, 2, ',', ' ') }}</strong></td>
                                                        </tr>

                                                        @empty
                                                        <p><span style="color: red; font-weight: 900; ">Za uvedený mesiac nemáte žiadne výpisy!</span></p>
                                                        @endforelse
                                                        <tr style="background: rgba(91, 113, 250, 0.33)">
                                                        <td></td>
                                                        {{--<td></td>--}}
                                                        <td></td>
                                                        <td style="text-align: center">Spolu: </td>
                                                        <td style="text-align: right"><strong>{{ number_format($posts->sum('price'), 2, ',', ' ')  }}</strong> Eu</td>
                                                        </tr>
                                                    </table>
                                                    <!-- // CONTENT TABLE -->
                                                        ...
                                                        <tr>
                                                            <td align="left" valign="top" class="flexibleContainerBox" style="background-color:#5F5F5F;">
                                                                <table border="0" cellpadding="30" cellspacing="0" width="100%" style="max-width:100%;">
                                                                    <tr>
                                                                        <td align="left" class="textContent">
                                                                            <h3 style="color:#FFFFFF;line-height:125%;font-family:Helvetica,Arial,sans-serif;font-size:20px;font-weight:normal;margin-top:0;margin-bottom:3px;text-align:left;">Ďakujeme</h3>
                                                                            <div style="text-align:left;font-family:Helvetica,Arial,sans-serif;font-size:15px;margin-bottom:0;color:#FFFFFF;line-height:135%;">
                                                                                Že využívate portál na zverejňovanie zmlúv a faktúr <a href="http://verejnyportal.eu/{{ $user->slug }}"verejný portál.eu.</a> <br>
                                                                                Určené len pre vnútornú potrebu užívateľa.
                                                                            </div>
                                                                        </td>
                                                                    </tr>
                                                                </table>
                                                            ...
                                                            <td align="right" valign="top" class="flexibleContainerBox" style="background-color:#27ae60;">
                                                                <table class="flexibleContainerBoxNext" border="0" cellpadding="30" cellspacing="0" width="100%" style="max-width:100%;">
                                                                    <tr>
                                                                        <td align="left" class="textContent">
                                                                            <div style="text-align:left;font-family:Helvetica,Arial,sans-serif;font-size:15px;margin-bottom:0;color:#FFFFFF;line-height:135%;">
                                                                                <a href="http://verejnyportal.eu/{{ $user->slug }}"><img style="height: 70px; float: left" src="http://verejnyportal.eu/image/dievca.png"></a>
                                                                            </div>
                                                                        </td>
                                                                    </tr>
                                                                </table>
                                                        ...
                                                        <tr>
                                                            <td align="center" valign="top">
                                                                ...
                                                                <table border="0" cellpadding="0" cellspacing="0" width="100%">
                                                                    <tr>
                                                                        <td valign="top" class="textContent">
                                                                            <div style="text-align:center;font-family:Helvetica,Arial,sans-serif;font-size:15px;margin-bottom:0;margin-top:3px;color:#5F5F5F;line-height:135%;">programoval: Gajdoš Gabriel, tel. 0905 320 616</div>
                                                                        </td>
                                                                    </tr>
                                                                </table>
                                                                <!-- // CONTENT TABLE -->
                                                    ...
                                                    <table border="0" cellpadding="30" cellspacing="0" width="100%">
                                                        <tr>
                                                            <td valign="top" bgcolor="#E1E1E1">
                                                                ...
                                                                <div style="font-family:Helvetica,Arial,sans-serif;font-size:13px;color:#828282;text-align:center;line-height:120%;">
                                                                    <div>Copyright &#169; 2017 <a href="http://www.verejnyportal.eu" target="_blank" style="text-decoration:none;color:#828282;"><span style="color:#828282;">Reprezent</span></a>. Všetky právy vyhradené.</div>
...
{{--<table style="width: 100%">--}}
    {{--<a href="http://verejnyportal.eu/{{ $user->slug }}"><img style="height: 70px; float: left" src="http://verejnyportal.eu/image/dievca.png"></a>--}}
    {{--<h2>Mesačný výpis dokladov {{ date("M Y", strtotime( date( "M Y", strtotime( date("M Y") ) ) . "-1 month" ) ) }} <br><span style="font-size: 60%; color: grey">Zverejnených na verejnyportal.eu</span>--}}
    {{--</h2>--}}
{{--</table>--}}
    {{--<h3><a href="http://verejnyportal.eu/{{ $user->slug }}">{{ $user->company }}</a> ,  {{ $user->street }}, {{$user->city}}</h3>--}}


{{--<table style="border: solid 2px black" class="altrowstable" id="alternatecolor">--}}
    {{--<tr style="padding: 5px ;background: rgba(91, 113, 250, 0.33)">--}}
        {{--<th>Pč.</th>--}}
        {{--<th>Popis položky</th>--}}
        {{--<th>Vytvorené</th>--}}
    ...
    {{--<tr style="background: rgba(91, 113, 250, 0.33)">--}}
        ...
        {{--<td></td>--}}
        {{--<td>Spolu: </td>--}}
        {{--<td><strong>{{ number_format($posts->sum('price'), 2, ',', ' ')  }}</strong> Eu</td>--}}
    {{--</tr>--}}
{{--</table>--}}


{{--<p>Ďakujeme že využívate portál na zverejňovanie zmlúv a faktúr <a href="http://verejnyportal.eu/{{ $user->slug }}"verejný portál.eu.</a> <br>--}}
    {{--Určené len pre vnútornú potrebu užívateľa.</p>--}}
