        ...
        <form method="POST" @submit.prevent>
            <div class="md:flex justify-between my-5 bg-gray-100">
                ...
                <button type="submit" @click="storeVote(1)"
                    ...
                    Súhlasim
                    <svg v-if="disabledButton" class="w-5 h-5 ml-2 text-white fill-current" xmlns="http://www.w3.org/2000/svg"
                         viewBox="0 0 20 20">
                        <path
                ...
                <button  @click="storeVote(2)"
                    ...
                    Zdržal
                    <svg v-if="disabledButton" class="w-5 h-5 ml-2 text-blue-600 fill-current"
