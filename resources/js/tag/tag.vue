<template>
    <div class="flex items-center  mr-2" @mouseover="hover = true" @mouseleave="hover = false">
        ...
        <div v-if="hover" class="flex mr-2 space-x-2 text-gray-500">
            ...
            <svg @click="destroyTag(tag)" class="h-4 w-4 fill-current cursor-pointer hover:text-gray-800"  xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke="currentColor">
