<template>
    <div class="card">
        ...
        <div class="col-md-12">
            <div class="row">
                <!--Left site-->
                <div class="col-md-6" style="padding: 15px; border: solid 1px #9999ab; background: silver">
                    <div class="row">
                        <!--A1-->
                        <div class="col-md-6">
                        ...
                        <div class="col-md-6">
                            <div class="form-group input-group-sm">
                                <label>Úhrada:</label>
                                <select v-model="customer.payment" class="form-control" required >
                            ...
                            <div class="form-group input-group-sm">
                                ...
                                <input type="text" v-model="customer.notes" class="form-control input-sm " placeholder="Poznámka">
                            </div>
                    </div>
                </div>
            </div>
...
<!--                                ></multiselect>-->
<!--                            </div>-->
<!--                        <select v-model="customer.contact_id" @change="changeContact($event)" class="form-control" required id="exampleSelect2">-->
...
<!--                    </div>-->
                    Detaily:
                    <strong>{{ customer.contact_id }}</strong><br>
                    <!--{{ selected.street }}<br>-->
    ...
    export default {
            ...
            customer: {
                handler(value) {
                   let customer = {
                       ...
                       notes: value.notes,
                       contact_id: value.contact_id.id,
                   };
                   this.$emit('customerDetailForm', customer)
                }, deep: true
            }
        },
        ...
        methods: {
            saveOrder(){
              ...
              this.$emit('headerForm', this.orderData);
            },
