<template>
    ...
    <section class="border" v-if="active.find(id => id.id == 6)">
        <header class="flex justify-between items-center px-2 py-2  cursor-pointer" @click="showCard =! showCard"
            ...
            <svg v-if="markAsCompleted.length" @click="multiUpdateCompleted" class="w-8 h-5 fill-current" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 20 20" fill="currentColor">
                <path fill-rule="evenodd"
