<template>
    <div
        class="border-gray-400 border-b-2"
        :class="{ 'border-green-500 border-2': dialog }"
    >
        <li
        ...
        >
            ...
            <div
                class="flex justify-between items-center text-xs w-full p-2 pl-2"
                @click="dialog = !dialog"
            >
                ...
                <input
                    ...
                    type="text"
                    v-model="task.name"
                    class="w-full h-8 px-2 mr-2 rounded"
                />
        ...
        <div v-if="dialog" class="p-2">
            <div class="w-full mb-8 flex justify-between">
                <div class="">
                    <span
                        ...
                        class="btn btn-small text-xs bg-green-200 px-1 cursor-pointer rounded-sm hover:bg-green-300"
                        >Vybavené</span
                    >
                    <span
                        v-else
                        @click="updateCompleted"
                        class="btn btn-small text-xs bg-green-100 px-1 cursor-pointer rounded-sm hover:bg-green-300"
                        >Obnoviť</span
                    >
                </div>
                ...
                <div v-if="userOwner">
                    <span
                        v-if="!isEditActive"
                        @click="editTask"
                        class="btn btn-small text-xs bg-green-100 px-1 cursor-pointer hover:bg-green-300 rounded-sm"
                        >Upraviť</span
                    >
                    <span
                        v-else
            ...
            <textarea
                v-else
                v-model="task.body"
                class="border w-full text-sm p-2 border-gray-400 rounded"
                >{{ task.body }}</textarea
            >
            ...
            <div
                v-if="isEditActive"
                @click="updateTask"
                class="my-3 py-2 text-white text-center bg-blue-500 hover:bg-blue-700 px-1 w-full cursor-pointer rounded-sm"
            >
                Uložiť zmeny
            </div>
